<?php
/**
 * 🗃️ Web-accessible Database Initialization
 * Initialize database schema via HTTP request
 */
...
echo "🚀 Purrr.love Database Initialization via Web\n";
echo "============================================\n\n";
...
$schemaFiles = [
    ...
    // Other schemas will be added later after MySQL conversion
];
        ...
        foreach ($statements as $statement) {
            ...
            try {
                ...
                if (strpos($e->getMessage(), 'already exists') === false && 
                    ...
                    strpos($e->getMessage(), 'duplicate value') === false) {
